...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{analysis/figs/fig9_ab_comparison.png}
\caption{振荡治理四项指标的组间对比：基线 / affine / 未标定 PWM /
归一化 PWM（$w{=}0.1$ 与 $w{=}0.2$）。}
\label{fig:ab}
\end{figure}
