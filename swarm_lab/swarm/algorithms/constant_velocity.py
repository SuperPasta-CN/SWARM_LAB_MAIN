...
from swarm.algorithms.task_driven import trivial_spec
...
class ConstantVelocityPlanner:
    ...
    def __init__(
        ...
        # Trivial no-edge spec: lets bootstrap run the standard preflight.
        self.topology = trivial_spec(self.vehicle_ids)
        self._elapsed = 0.0
