...
Usage:
    python run_experiment.py                          # default: bearing_three
    python run_experiment.py --config bearing_two
    python run_experiment.py --config bearing_four
    python run_experiment.py --config bearing_six
    python run_experiment.py --yes --no-plot --no-record

The script runs preflight checks (mocap validity, leader-anchor bearing
consistency, minimum separation) before any wheel command is issued.
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        default="bearing_three",
        help="configuration module, default: configs.bearing_three",
    )
    parser.add_argument(
        "--yes",
        action="store_true",
